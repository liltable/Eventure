  ...
  options: [
    {
      ...
      options: [
        ...
        {
          name: "winners",
          description: "select the ammount of winners for this giveaway.",
          type: "INTEGER",
          required: true
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "message-id",
          description: "Provide a message id for the giveaway.",
          type: "STRING",
          required: true
        }
      ]
    ...
    switch(Sub) {
      ...
      case "actions" : {
       ...
       const giveaway = client.giveawaysManager.giveaways.find((g) => g.guildId === interaction.guildId && g.messageId === messageId);
        ...
        if (!giveaway) {
          errorEmbed.setDescription(`Unable to find the giveaway with the message id : ${messageId} in 
          this guild.`);
          return interaction.reply({embeds: [errorEmbed],ephemeral: true});
        }
        ...
        switch(choice) {
          ...
          case "reroll" : {
              ...
              successEmbed.setDescription("giveaway has been reroll.");
              return interaction.reply({embeds: [successEmbed], ephemeral: true})
            }).catch((err) => {
                errorEmbed.setDescription(` An error has occurred \n\`${err}\``)
                return interaction.reply({embeds: [errorEmbed],ephemeral: true});
